...
export const quizzes: Quiz[] = [
  {
    ...
    lessons: [
      ...
      },
      {
        ...
        highlight: "텍스트 기록 / 칼로리는 조장 정리 / 이상하면 톡방에 말하기",
      },
      {
        id: "diet-l3",
        title: "활동 계획 — 3단계",
    ...
    questions: [
      ...
      },
      {
        ...
        correctAnswer: false,
        explanation: "벌금은 따로 기록되며, 나중에 한 번에 걷습니다. 매번 송금하지 않아요.",
      },
      {
        id: "diet-q6",
        type: "ox",
      ...
      },
      {
        ...
        options: [
          { id: "a", text: "그냥 넘어간다" },
          { id: "b", text: "톡방에 음식 단위 말하면서 이상하다고 알린다" },
          { id: "c", text: "직접 다시 계산한다" },
          { id: "d", text: "조장에게 DM 보낸다" },
        ],
        correctAnswer: "b",
        explanation: "단위 문제로 칼로리가 이상할 수 있어요. 톡방에 음식 단위를 말하면서 이상하다고 알려주세요.",
      },
      {
        id: "diet-q10",
        type: "multiple-choice",

...
export const quizzes: Quiz[] = [
  {
    ...
    lessons: [
      ...
      },
      {
        ...
        title: "규칙 & 벌금",
        content:
          "벌금 2,000원\n\n부과 조건:\n· 하루종일 식단을 기록하지 않은 경우\n· 매주 일요일 기준, 주 3회 이상 목표 달성 실패 시\n\n참고로, 3끼 중 1~2끼만 기록해도\n기록한 것으로 인정됩니다.\n다만 목표 달성에는 영향이 있을 수 있어요.\n\n벌금이 무서워서가 아니라,\n습관이 생겨서 안 걷히게 되는 게 목표예요.\n\n모인 벌금은\n활동 우수자 상품 +\n마무리 모임 음식 재료비로 사용합니다.",
        highlight: "벌금 2,000원 — 하루 미기록 시 / 주 3회 목표 실패 시 (일요일 기준)",
      },
      {
        id: "diet-l5",
        title: "목표 1 — 인식",
    ...
    questions: [
      ...
      },
      {
        id: "diet-q6",
        type: "ox",
        question: "매주 일요일 기준으로, 주 3회 이상 목표 달성에 실패하면 벌금이 부과된다.",
        correctAnswer: true,
        explanation: "매주 일요일 기준으로 확인하며, 주 3회 이상 목표 실패 시 벌금 2,000원이 부과됩니다.",
      },
      {
        id: "diet-q7",
        type: "multiple-choice",

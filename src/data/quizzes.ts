  ...
  },
  {
    ...
    lessons: [
      {
        ...
        title: "식단하조 웹사이트는?",
        content:
          "우리 조의 **식단 기록을 한눈에**\n확인할 수 있는 공식 사이트예요.\n\n주소: **sikdan-hajo.vercel.app**\n\n하단에 **4개의 메인 탭**이 있고,\n별도로 **계산기 2개**와\n**멤버 상세 페이지**로 이동할 수 있어요.\n\n**홈** — 오늘 멤버들 식단 현황\n**리포트** — 일간/주간/누적 벌금\n**음식** — 영양소 정보 DB (664개+)\n**목표** — 내 목표 & 벌금 규칙\n\n지금부터 하나씩 살펴볼게요.",
        highlight: "4개 메인 탭 + 계산기 + 멤버 상세",
      },
      {
        id: "use-l2",
        title: "① 홈 — 오늘 식단 현황",
      ...
      },
      {
        ...
        highlight: "벌금 규칙 · IF 면제 · 신규 3일 유예 · 일요일 정산",
        image: {
      ...
      },
      {
        ...
        title: "🧮 보너스 — 계산기 2개",
        content:
          "바텀 네비에는 없지만\n**/calculator** 와 **/bmr** 경로로\n두 가지 계산기를 쓸 수 있어요.\n\n**칼로리 추천** (`/calculator`)\n4단계 스텝 UI\n성별 → 나이·키·몸무게 → 활동량 → 목표\n결과: 하루 권장 kcal + 탄·단·지 그램 + 비율\n\n**기초대사량(BMR)** (`/bmr`)\n한 화면 입력 (해리스-베네딕트 공식)\n성별·나이·키·몸무게\n결과: BMR + 활동량별 TDEE 4개\n+ 다이어트 목표별 권장 칼로리 4개\n\n상단 **\"칼로리 추천 / 기초대사량\"** 탭으로\n두 계산기 사이를 자유롭게 이동",
        highlight: "/calculator 4단계 스텝 · /bmr 한 화면 + 공식 표시",
        image: {
    ...
    questions: [
      ...
      },
      {
        id: "use-q12",
        type: "multiple-choice",
        question: "바텀 네비에는 없지만 별도 경로로 쓸 수 있는 계산기는?",
        options: [
          { id: "a", text: "환율 계산기 / 단위 변환기" },
          { id: "b", text: "칼로리 추천(/calculator) / BMR(/bmr)" },
          { id: "c", text: "운동 칼로리 계산기 / 심박수 계산기" },
          { id: "d", text: "체지방률 / 골밀도 계산기" },
        ],
        correctAnswer: "b",
        explanation:
          "/calculator 는 4단계 칼로리 추천, /bmr 은 해리스-베네딕트 공식으로 기초대사량을 계산합니다.",
      },
      {
        id: "use-q13",
        type: "ox",
